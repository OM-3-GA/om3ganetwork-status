...
# The following option only applies if SQLite is the datastore:

SQLITE_DB_FILE = "sqlite.db" # Name of the sqlite database file stored in the instance directory.
